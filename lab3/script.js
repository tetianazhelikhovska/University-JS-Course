...
// Я додав селекціонування імен за сумою ASCII-кодів 
// їхніх літер. Якщо сума ASCII-кодів імені перевищує
// поріг (500), воно буде виведене в консоль з 
// відповідним повідомленням. Це дозволяє фільтрувати 
// імена за складністю написання чи довжиною.